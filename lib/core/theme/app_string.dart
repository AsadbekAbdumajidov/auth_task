class AppString {
  ...
  static String strEmailHint = "Логин или почта";
  static String strPassword = "Пароль";
  static String strSignIn = "Войти";
  static String strSignUp = "Зарегистрироваться";
  static String strProfile = "Профиль";
  static String strRibbon = "Лента";
  static String strMap = "Карта";
